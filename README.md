...
**[Space Travelers' Hub]** is an application for a company that provides commercial and scientific space travel services. The application will allow users to book rockets and join selected space missions.
...
```sh
  git clone https://github.com/Kaghenimbale/space_traveler.git
  cd bookstore-app
```
...
This project is [MIT](https://github.com/Kaghenimbale/space_traveler/blob/dev/LICENSE) licensed.
